...
def display_lessongroup_timetable (timetable: list, lesson_group) -> None:
    ...
    outL5 = f"|{w1THUp1}|{w1THUp2}|{w1THUp3}|{w1THUp4}|{w1THUp5}|{w2THUp1}|{w2THUp2}|{w2THUp3}|{w2THUp4}|{w2THUp5}|"
    outL6 = f"|{w1FRIp1}|{w1FRIp2}|{w1FRIp3}|{w1FRIp4}|{w1FRIp5}|{w2FRIp1}|{w2FRIp2}|{w2FRIp3}|{w2FRIp4}|{w2FRIp5}|"
